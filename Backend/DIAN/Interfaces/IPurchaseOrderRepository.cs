...
namespace DIAN_.Interfaces
{
    ...
    {
        Task<(List<Purchaseorder> Orders, int TotalCount)> GetAllPurchaseOrderAsync(PurchaseOrderQuerry querry); //not need to know who is assigned
        ...
        Task<IEnumerable<Purchaseorder>> GetOrdersForCusAsync(int CustomerId);
    }
}
