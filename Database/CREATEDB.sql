...
CREATE TABLE ORDERDETAIL (
    OrderDetailID NVARCHAR(36) PRIMARY KEY,
...
CREATE TABLE WARRANTY (
    OrderDetailID NVARCHAR(36) PRIMARY KEY FOREIGN KEY REFERENCES ORDERDETAIL(OrderDetailID),
...
--INSERT ORDERDETAIL (VAN DE O CHO SUBDIAMOND)
INSERT INTO ORDERDETAIL (OrderDetailID, OrderID,[LineTotal], ProductID, [ShellInventoryID], [SubDiamondID]) VALUES
