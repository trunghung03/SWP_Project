...
IF EXISTS(SELECT * FROM sys.databases WHERE name = 'DIAN0607')
BEGIN
    -- If the database exists, drop it
    ALTER DATABASE DIAN0607 SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE DIAN0607;
END
GO
-- Create the new database
CREATE DATABASE DIAN0607;
GO
