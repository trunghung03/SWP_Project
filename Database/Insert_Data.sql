...
('PROD003', 'Riviera Eternity Ring', 1990.00, 'This ring showcases lab diamonds in a continuous band, creating an eternity effect.', 64.00, 'https://image.brilliantearth.com/cdn-cgi/image/width=886,height=1026,quality=100,format=auto/https://cdn.builder.io/api/v1/image/assets%2F9f2a69003c86470ea05deb9ecb9887be%2F93d5b00ce13b4ce78f3e888bc481a478', 1, 2, 9),
...
('PROD038', 'Riviera Eternity Ring', 1990.00, 'This ring showcases lab diamonds in a continuous band, creating an eternity effect.', 64.00, 'https://image.brilliantearth.com/cdn-cgi/image/width=886,height=1026,quality=100,format=auto/https://cdn.builder.io/api/v1/image/assets%2F9f2a69003c86470ea05deb9ecb9887be%2F2745634697ec4fe8a5625ffdb209199a', 1, 2, 9),
...
(2, '2023-02-20', 'PayPal', 'Jane Smith', '234-567-8901', '456 Elm St', 3050.00, 'Completed', 2, 1, 'Deliver ASAP', 3, 4),
(3, '2023-02-28', 'Credit Card', 'Alice Johnson', '345-678-9012', '789 Oak St', 1750.00, 'Completed', 1, 0, 'Extra packaging needed', 2, 3),
...
(4, '2024-03-05', 'PayPal', 'Bob Brown', '456-789-0123', '101 Pine St', 2900.00, 'Cancelled', 3, 1, 'Handle with care', 1, 5),
(5, '2024-04-10', 'Credit Card', 'Carol White', '567-890-1234', '202 Cedar St', 3800.00, 'Pending', 4, 0, 'Leave at doorstep', 3, 6),
(6, '2024-05-15', 'PayPal', 'David Black', '678-901-2345', '303 Birch St', 4200.00, 'Cancelled', 5, 1, 'Hold for pickup', 2, 3),
(7, '2024-06-25', 'Credit Card', 'Eve Green', '789-012-3456', '404 Maple St', 4400.00, 'Delivering', 6, 0, 'Signature required', 4, 7);
...
(13, 5000.00, 6, 3, 23.0, 1),
(14, 4500.00, 7, 1, 10.0, 1),
(15, 4500.00, 4, 1, 10.0, 1),
(16, 4500.00, 6, 1, 10.0, 1),
(17, 4500.00, 8, 1, 10.0, 1),
(18, 4500.00, 9, 1, 10.0, 1);
