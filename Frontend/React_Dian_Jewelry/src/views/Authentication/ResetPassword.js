        ...
        <div className="col-lg-6 col-md-6 col-sm-12 rp_left_side">
          <form className="reset_password_form" onSubmit={handleResetPassword}>
            ...
            <div className="rp_password_section mb-3 position-relative">
              <label className="rp_password_label" htmlFor="password">
                Enter new password
              </label>
              <input
                type="password"
            ...
            <div className="rp_re_password_section mb-3 position-relative">
              <label className="rp_password_label" htmlFor="re_password">
                Re-enter password
              </label>
              <input
                type="password"
            ...
            <div className="rp_submit_section">
              <button
                type="submit"
                className="rp_button btn btn-block"
                disabled={loading}
              >
                {loading && (
                  <i
