...
import {
    deleteDiamondById, deleteSubDiamondById, getAllSubDiamond, ShowAllDiamond, allMainDiamondPDF, allSubDiamondPDF
} from "../../../services/ManagerService/ManagerDiamondService";
import "../../../styles/Manager/ManagerList.scss";
import DiamondTable from "./DiamondTable";
import {set} from "react-hook-form";

const mainDiamondTableColumns = ["ID", "Attribute ID", "Shape", "Color", "Clarity", "Carat", "Cut", "Price", "Certificate", "Status", "Actions",];

const subDiamondTableColumns = ["ID", "Attribute ID", "Shape", "Color", "Clarity", "Carat", "Cut", "Price", "Quantity", "Actions",];
...
export default function DiamondTypeSwitcher() {
    ...
    const [pagination, setPagination] = useState({
        totalPages: 1, pageSize: 6, currentPage: 1,
    });
    ...
    useEffect(() => {
        ...
        setPagination({
            ...pagination, pageSize: 6, currentPage: pageNumber,
        });
        // fetchData(pageNumber, value === 0 ? "main" : "sub");
    }, [searchParams, value]);
