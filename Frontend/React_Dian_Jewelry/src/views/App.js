      ...
      <UserProvider>
        <CartProvider>
          ...
          <Routes>
            ...
            {/* Sales Staff */}
            <Route path="/sales-staff-order-list" element={<ProtectedRoute requiredRole="SalesStaff" path="/sales-staff-order-list" element={SSOrderList} />} />
            <Route path="/sales-staff-content-list" element={<ProtectedRoute requiredRole="SalesStaff" path="/sales-staff-content-list" element={SSContentList} />} />
            <Route path="/sales-staff-add-content" element={<ProtectedRoute requiredRole="SalesStaff" path="/sales-staff-add-content" element={SSAddContent} />} />
            <Route path="/sales-staff-warranty-list" element={<ProtectedRoute requiredRole="SalesStaff" path="/sales-staff-warranty-list" element={SSWarrantyList} />} />
            <Route path="/rich-text-page" element={<ProtectedRoute requiredRole="SalesStaff" path="/rich-text-page" element={RichTextPage} />} />
