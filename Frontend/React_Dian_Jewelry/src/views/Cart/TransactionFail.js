      ...
      <div className="transaction_fail_main_container container">
        <div className="row">
          <div className="transaction_fail_content col-md-6">
            ...
            <p>
              The payment was unsuccessful due to some abnormality. Please try
              again later or use another payment method. If this is a mistake,
              please contact us through the hotline for support.
            </p>
            <div className="transaction_fail_button_wrapper">
              <button
                onClick={() =>
                  handleNavigate("/diamond-jewelry", { category: "all" })
                }
                className="transaction_fail_shop_button"
              >
                Continue shopping
              </button>
              <button
                onClick={() => handleNavigate("/contact")}
                className="transaction_fail_contact_button"
              >
                Contact us
              </button>
            </div>
