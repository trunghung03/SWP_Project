                ...
                {expanded && (
                    <div className="salesstaff_sidebar_content">
                        <ul className="salesstaff_sidebar_menu">
                            ...
                            <li className={`salesstaff_sidebar_menu_item ${currentPage === 'salesstaff_edit_profile' ? 'selected' : ''}`} onClick={() => this.props.navigate('/staff-edit-profile')}>
                ...
                {!expanded && (
                    <div className="salesstaff_sidebar_icons">
                        <ul className="salesstaff_sidebar_menu_icons">
                            ...
                            <li className={`salesstaff_sidebar_menu_item ${currentPage === 'salesstaff_edit_profile' ? 'selected' : ''}`} data-tooltip="Edit Profile" onClick={() => this.props.navigate('/staff-edit-profile')}>
                                <i className="fas fa-user"></i>
                            </li>
