...
const HeaderComponent = () => {
  ...
  //     title: "Title 1",
  //     description:
  //       "Description for title 1 Description for title 1 Description for title 1",
  //     time: "1 hour ago",
  //   },
  //   {
  //     id: 2,
  //     title: "Title 2",
  //     description: "Description for title 2222222222222222222222222222222",
  //     time: "2 hours ago",
  //   },
  //   {
  //     id: 3,
                    ...
                    <>
                      ...
                      <li>
                        <Link className="dropdown-item" to="/edit-profile">
                          <i className="adm_icon fas fa-cog"></i> Setting
                        </Link>
                      </li>
                      <li>
