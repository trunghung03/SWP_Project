...
const MessageParser = ({ children, actions }) => {
  const parse = (message) => {
    ...
    } else if (trimmedMessage.includes('location') || trimmedMessage.includes('where are you') || trimmedMessage.includes('where your store') || trimmedMessage.includes('where the store') || trimmedMessage.includes('where store') || trimmedMessage.includes('where is your store') || trimmedMessage.includes('how to find store') || trimmedMessage.includes('address') || trimmedMessage.includes('direct transaction') || trimmedMessage.includes('visit') || trimmedMessage.includes('direction')) {
    ...
    } else if (trimmedMessage.includes('shape') || trimmedMessage.includes('shapes') || trimmedMessage.includes('which shape do you have') || trimmedMessage.includes('which shape you have') || trimmedMessage.includes('which shapes do you have') || trimmedMessage.includes('which shapes you have') || trimmedMessage.includes('round') || trimmedMessage.includes('oval') || trimmedMessage.includes('cushion') || trimmedMessage.includes('emerald') || trimmedMessage.includes('pear') || trimmedMessage.includes('radiant') || trimmedMessage.includes('princess') || trimmedMessage.includes('marquise') || trimmedMessage.includes('asscher') || trimmedMessage.includes('heart')) {
      actions.handleProductInfo('shape' );
