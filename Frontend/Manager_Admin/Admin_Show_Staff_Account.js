function Admin_Show_Staff_Account() {
    return (
        <>
            <div class="main" style={{backgroundColor: "white"}}>
                <div class="text-center">
                    ...
                    <div class="form-wrapper m-5">
                        <h1 id="formHeader" class="d-flex display-4 justify-content-start mt-5 mb-2">Staff accounts</h1>
...
export default Admin_Show_Staff_Account;